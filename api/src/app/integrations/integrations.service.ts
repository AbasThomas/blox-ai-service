...
const PROVIDERS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    category: 'creative',
    mode: 'oauth',
    authUrl: `${OAUTH_BASE}/dribbble`,
    scopes: ['public'],
    priority: 'optional',
    oauthEnvKeys: ['DRIBBBLE_CLIENT_ID', 'DRIBBBLE_CLIENT_SECRET'],
    setupDocsUrl: 'https://dribbble.com/account/applications',
  },
  {
    id: 'canva',
    name: 'Canva',
    category: 'creative',
    mode: 'oauth',
    authUrl: `${OAUTH_BASE}/canva`,
    scopes: ['profile:read', 'design:meta:read'],
    priority: 'optional',
    oauthEnvKeys: ['CANVA_CLIENT_ID', 'CANVA_CLIENT_SECRET'],
    setupDocsUrl: 'https://www.canva.com/developers/',
  },
  {
    id: 'figma',
    name: 'Figma',
