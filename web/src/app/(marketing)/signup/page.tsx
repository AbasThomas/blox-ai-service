          ...
          <form className="space-y-5" onSubmit={handleSubmit} aria-label="Sign up form" noValidate>
            ...
            {step === 1 ? (
              <>
                ...
                <button
                  type="submit"
                  className="group mt-8 flex w-full items-center justify-center gap-2 rounded-xl bg-[#1ECEFA] px-4 py-3 text-sm font-bold text-black transition-all hover:bg-white hover:scale-[1.02] active:scale-[0.98]"
                >
                  CONTINUE TO ORIGIN
              ...
              <>
                ...
                <div className="mt-8 flex gap-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="group flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#1ECEFA] px-4 py-3 text-sm font-bold text-black transition-all hover:bg-white hover:scale-[1.02] active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50"
                  >
