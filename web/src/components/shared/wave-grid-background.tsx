...
export function WaveGridBackground({
  ...
  useEffect(() => {
    ...
    const setCanvasSize = () => {
      ...
      // Reset transform before applying DPR scaling to avoid cumulative scaling on resize.
  ...
  return (
    <div ref={containerRef} className={cn("absolute inset-0 overflow-hidden bg-[#030712]", className)}>
